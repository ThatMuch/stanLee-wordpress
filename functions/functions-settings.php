...
function _s_enqueue()
{
	...
	// Scripts
	wp_register_script('_s/scripts', get_template_directory_uri() . '/assets/scripts/custom.min.js', false, array('jquery'), true);
	...
	wp_enqueue_style('_s/styles', get_template_directory_uri() . '/assets/styles/style.min.css', false, null);
	// Typekit
	global $typekit_id;
	if ($typekit_id) :
