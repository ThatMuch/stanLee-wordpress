	...
	$plugins = array(
		...
		// This is an example of how to include a plugin bundled with a theme.
 		array(
			...
			'version'            => '5.8.9',                                                                    // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
