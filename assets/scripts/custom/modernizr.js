...
!(function (e, n, t) {
    ...
    function f(e, t, r, o) {
        ...
        return (
            ...
            d.fake &&
                ...
                _.appendChild(d)),
            (s = t(c, e)),
            d.fake ? (d.parentNode.removeChild(d), (_.style.overflow = u), _.offsetHeight) : c.parentNode.removeChild(c),
            !!s
        );
    }
    function u(e) {
    ...
    Modernizr.addTest("objectfit", !!N("objectFit"), { aliases: ["object-fit"] }), o(), i(S), delete C.addTest, delete C.addAsyncTest;
